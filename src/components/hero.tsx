  ...
  return (
    <div className="w-full h-screen text-center text-text relative z-0 pt-14 px-5 flex flex-col items-center">
      ...
      <div className="mt-10 flex items-center justify-center flex-col">
        ...
        />
        <button className="rounded-lg w-80 bg-accent font-bold text-background p-3 mt-4 border border-accent hover:bg-transparent hover:text-accent transition-all">
          Shorten
        </button>
      </div>
